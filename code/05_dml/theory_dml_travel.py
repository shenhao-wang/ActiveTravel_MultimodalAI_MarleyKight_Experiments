"""
Theory-Driven Scalar DML — Job A: RF/GB × Full/NoTravel
22 features × 4 specs × B=500. Resume-safe.
Output: theory_dml_travel_results.csv
"""
...
# ── SPECS: Full vs No-Travel controls ─────────────────────────
...
PARTIAL_PATH = 'theory_dml_travel_partial.csv'
completed = set()
results = []
...
# hypothesis family; pooling across RF/GB/Full/NoTravel would over-correct.
...
out.to_csv('theory_dml_travel_results.csv', index=False)
print(f'Saved: theory_dml_travel_results.csv')
...
pivot.to_csv('theory_dml_travel_pivot.csv', index=False)
print(f'Saved: theory_dml_travel_pivot.csv')
print('\n✓ Complete.')
